...
export const downloadGalleryPhoto = async (): Promise<Array<Promise<ItemGallery>>> => {
...
export const deletePhotoGallery = (fullPath: string): Promise<firebase.storage.Reference> => {
  return firebase
    .storage()
    .ref(fullPath)
    .delete();
